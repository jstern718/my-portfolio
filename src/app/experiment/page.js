...
//================================================================
  ...
  return (
    <main className="bg-white min-h-screen pt-28 pb-20 px-6 md:px-10">
     {/* Header */}
      <div className="max-w-5xl mx-auto">
         <div className="bg-work/10 m-1 mb-3 pt-3 pb-3 outline-4 outline-solid outline-black rounded-xl
